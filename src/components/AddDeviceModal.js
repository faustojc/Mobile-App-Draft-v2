      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <View style={styles.inputContainer}>
            <MaterialCommunityIcons name="barcode-scan" size={20} color="#94A3B8" />
            <TextInput
              style={styles.input}
          ...
          <Text style={styles.helperText}>Find this on the sticker of your device.</Text>

          <Text style={[styles.label, { marginTop: 16 }]}>Device Nickname</Text>
          <View style={styles.inputContainer}>
            <MaterialCommunityIcons name="tag-outline" size={20} color="#94A3B8" />
            <TextInput
              style={styles.input}
